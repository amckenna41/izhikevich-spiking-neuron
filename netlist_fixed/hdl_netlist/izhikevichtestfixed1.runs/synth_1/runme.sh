...
HD_PWD='I:/netlist_fixed/hdl_netlist/izhikevichtestfixed1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log izhikevichtestfixed1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source izhikevichtestfixed1.tcl
