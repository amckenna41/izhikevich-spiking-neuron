...
HD_PWD='I:/netlist_fixed/hdl_netlist/izhikevichtestfixed1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log izhikevichtestfixed1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source izhikevichtestfixed1.tcl -notrace
